...
public class GoldMedalController {
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        var countryOptional = this.countryRepository.getByName(countryName);// get the country
    ...
    private List<CountrySummary> getCountrySummaries(String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            ...
            case "medals":
            default:
                countries = ascendingOrder ? countryRepository.getAllByOrderByPopulationAsc() : countryRepository.getAllByOrderByPopulationDesc();// list of countries in any order you choose; for sorting by medal count, additional logic below will handle that
                break;
        }
